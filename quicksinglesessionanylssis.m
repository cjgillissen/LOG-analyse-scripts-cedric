...
Side = [Side LOG.Side];
 ...
 guidur = guidurleft;
 guidur(strcmp(Side,'right'))= guidurright(strcmp(Side,'right'));
 ...
 sideopt = {'left','right'};
     ...
     for j = setupopt
       for k = sideopt
         figure;
         histogram(guidur(strcmp(Side,k)&setup==j&~gavepassive&strcmp(Reaction,'Hit')&~passivefirst)-(valvedur(strcmp(Side,k)&setup==j&~gavepassive&strcmp(Reaction,'Hit')&~passivefirst)),0:2:100);
         xlim([0 100])
